"""Publicação de eventos de conquista → social-service (athlos.social)."""
...
async def close_social_achievement_publisher() -> None:
...
async def publish_achievement_event(payload: dict[str, Any]) -> None:
    ...
    await exchange.publish(
        ...
        routing_key=RK_ACHIEVEMENT_NOTIFY,
    )
