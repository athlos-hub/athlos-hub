...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "privacy", sa.Enum("PUBLIC", "PRIVATE", name="org_privacy"), nullable=False
        ),
        sa.Column(
            "join_policy",
            sa.Enum(
    ...
    op.create_index(
        op.f("ix_organization_organizers_organization_id"),
        "organization_organizers",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_organization_organizers_user_id"),
        "organization_organizers",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "ACTIVE", "INVITED", "BANNED", name="member_status"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_organization_organizers_user_id"), table_name="organization_organizers"
    )
    op.drop_index(
        op.f("ix_organization_organizers_organization_id"),
        table_name="organization_organizers",
    )
