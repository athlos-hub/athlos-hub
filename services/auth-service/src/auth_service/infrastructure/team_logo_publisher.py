"""Publicação de sincronização de escudo → competitions-service (athlos.competitions)."""
...
async def close_team_logo_publisher() -> None:
...
async def publish_team_logo_sync(
    team_id: UUID, logo_url: str | None
) -> None:
    ...
    await exchange.publish(
        ...
        routing_key=RK_TEAMS_LOGO_SYNC,
    )
