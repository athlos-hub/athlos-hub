...
public class OrganizationPostController {
    ...
    public ResponseEntity<ApiResponse<Post>> createPost(
        ...
        if (!profileContextService.canCreatePostAsOrganization(slug)) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Você não tem permissão para criar posts nesta organização");
        }
    ...
    public ResponseEntity<ApiResponse<Void>> deletePost(
        ...
        if (!profileContextService.canCreatePostAsOrganization(slug)) {
            throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Você não tem permissão para deletar posts desta organização");
        }
