...
from notifications_service.common.exceptions import AppException, TokenExpiredError
from notifications_service.infrastructure.database.exceptions import DatabaseError as TechnicalDatabaseError
